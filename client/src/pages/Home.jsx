  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-indigo-900 to-gray-900 text-white p-4 flex flex-col items-center">
        ...
        {/* --- NEW: Home FAQ (keeps SEO text length intact) --- */}
        <section id="faq" className="w-full max-w-2xl text-left mt-2 mb-16">
          <h2 className="text-2xl font-bold mb-4">Fantasy Name Creator – FAQ</h2>
