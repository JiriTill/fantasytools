        ...
        <Helmet>
          ...
          <script type="application/ld+json">
            {JSON.stringify({
              ...
              "datePublished": datePublished, // full datetime + timezone
              "dateModified": dateModified,   // full datetime + timezone
        ...
        <div className="max-w-3xl space-y-6">
          ...
          <div className="mt-10 p-6 bg-gray-800 rounded-lg shadow-lg border border-gray-700">
            ...
            <div className="flex flex-col space-y-3">
              <Link to="/blog/why-names-matter" className="text-lg text-purple-400 hover:text-purple-300 transition-colors" onClick={scrollToTop}>
