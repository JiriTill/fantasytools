...
export default function FiveTipsForWorldbuilding() {
  ...
  // Function to scroll the window to the top on link click.
  const scrollToTop = () => {
    window.scrollTo(0, 0);
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-900 to-gray-900 text-white">
      ...
      <Helmet>
        <title>5 Essential Tips for Worldbuilding: Create a Cohesive Fantasy World</title>
        <meta
          name="description"
          content="Master the art of fantasy worldbuilding with our top 5 tips. Learn how to create a rich, cohesive world with consistent lore, magic systems, and naming conventions. Perfect for writers, DMs, and storytellers."
        />
        <meta
          name="keywords"
          content="worldbuilding tips, fantasy world, lore creation, writing guide, naming conventions, cohesive world, storytelling, RPG worldbuilding, fantasy name generator"
        />
        <meta property="og:title" content="5 Essential Tips for Worldbuilding: Create a Cohesive Fantasy World" />
        <meta
          property="og:description"
          content="A guide for writers and game masters on how to build a fantasy world that feels real and lived-in by focusing on key elements like history, magic, and culture."
        />
      ...
      <div className="max-w-3xl space-y-6">
        ...
        <div className="mt-10 p-6 bg-gray-800 rounded-lg shadow-lg border border-gray-700">
            ...
            <div className="flex flex-col space-y-3">
              <Link to="/why-names-matter" className="text-lg text-purple-400 hover:text-purple-300 transition-colors" onClick={scrollToTop}>
                → Why Names Matter in Fantasy Worlds?
              </Link>
              <Link to="/blog/lore-rich-names" className="text-lg text-purple-400 hover:text-purple-300 transition-colors" onClick={scrollToTop}>
                → How to Create Lore-Rich Names for Your Characters
              </Link>
              <Link to="/blog/gender-specific-names" className="text-lg text-purple-400 hover:text-purple-300 transition-colors" onClick={scrollToTop}>
